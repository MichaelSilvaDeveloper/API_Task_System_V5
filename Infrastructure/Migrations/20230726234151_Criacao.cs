            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NTC_ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NTC_TITULO = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    NTC_INFORMACAO = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TB_Task", x => x.NTC_ID);
                    table.ForeignKey(
                        name: "FK_TB_Task_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
