...
namespace API_Task_System_V5
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IUsuario, UserRepository>();      
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "API_Task_System_V5", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "API_Task_System_V5 v1"));
            }
